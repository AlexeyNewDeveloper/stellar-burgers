...
export default class BurgerConstructor extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      openPopupForPlaceOrder: false,
    };
  }

  openPopup = () => {
    this.setState({ ...this.state, openPopupForPlaceOrder: true });
  };

  closePopup = () => {
    this.setState({ ...this.state, openPopupForPlaceOrder: false });
  };
  ...
  render() {
    return (
      <section className={`${styles.section} pt-25 pl-4`}>
        ...
        {this.state.openPopupForPlaceOrder ? (
          <PopupForPlaceOrder closePopupCallback={this.closePopup} />
        ) : (
          ""
        )}
      </section>
